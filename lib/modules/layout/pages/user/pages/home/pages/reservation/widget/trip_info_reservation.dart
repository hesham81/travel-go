      ...
      child: Column(
        children: [
          ...
          LabelsWidget(
            ...
            value:
                "${(provider.getTotalUsers == 0) ? provider.getSelectedDeparture!.trip.price : provider.getTotalUsers * provider.getSelectedDeparture!.trip.price} ${provider.getSelectedDeparture!.trip.currency}",
          ),
        ],
      ),
    );
