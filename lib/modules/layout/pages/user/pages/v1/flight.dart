...
class DahabTripScreen extends StatelessWidget {
  static const routeName = '/dahab-trip-screen';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(
                      'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Blue_Hole_2005.JPG/800px-Blue_Hole_2005.JPG'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            ...
            buildProgramLineSection(
                '20', 'Day 1', 'Blue Hole', 'Dahab', ['Scuba Diving']),
            buildProgramLineSection('21', 'Day 2', 'Laguna Beach', 'Dahab',
                ['Swimming', 'Relaxing', 'Kitesurfing']),
            buildProgramLineSection('22', 'Day 3', 'Three Pools', 'Dahab',
                ['Snorkeling', 'Diving']),
            SizedBox(height: 20),
            Row(
  ...
  Widget buildProgramLineSection(String id, String day, String location,
      String attractionLocation, List<String> activities) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Card(
  ...
  Widget buildAttractionSection(
      String attractionId, String location, List<String> activities) {
