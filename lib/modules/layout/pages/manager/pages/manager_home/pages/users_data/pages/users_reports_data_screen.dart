...
class UsersReportsDataScreen extends StatefulWidget {
  const UsersReportsDataScreen({super.key});

  @override
  State<UsersReportsDataScreen> createState() => _UsersReportsDataScreenState();
}

class _UsersReportsDataScreenState extends State<UsersReportsDataScreen> {
  List<Users> users = [];
  List<Users> adminUsers = [];
  List<Users> managerUsers = [];
