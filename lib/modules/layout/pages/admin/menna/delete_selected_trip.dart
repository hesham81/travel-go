...
class _DeleteSelectedTripState extends State<DeleteSelectedTrip> {
  ...
  Future<void> _getFlightAndHotel() async {
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      LabelsWidget(
                        label: "From : ",
                        value: widget.trip.programDetails.first.from
                            .format(context),
                      ),
                      0.01.height.hSpace,
                      LabelsWidget(
                        label: "To : ",
                        value:
                            widget.trip.programDetails.first.to.format(context),
                      ),
                      0.01.height.hSpace,
                      DividersWord(
                        text: "Flight",
                      ...
                      LabelsWidget(
                        label: "Flight Id : ",
                        value: flight?.flightId ?? "No Flight Id",
                      ),
                      0.01.height.hSpace,
                      LabelsWidget(
                        label: "Flight Name : ",
                        value: flight?.flightName ?? "No Flight Name",
                      ),
                      0.01.height.hSpace,
                      LabelsWidget(
                        label: "Flight Airline : ",
                        value: flight?.airline?.flighAirLineName ?? "No Flight Airline",
                      ),
                      0.01.height.hSpace,
                      DividersWord(
                        text: "Hotel",
                      ...
                      LabelsWidget(
                        label: "Hotel Name : ",
                        value: hotel?.hotelName ?? "No Hotel Name",
                      ),
                      0.01.height.hSpace,
                      LabelsWidget(
                        label: "Hotel Location : ",
                        value: hotel?.hotelLocation ?? "No Hotel Location",
                      ),
                      0.01.height.hSpace,
                      LabelsWidget(
                        label: "Total Rooms : ",
                        value: "${hotel?.totalRooms ?? 0} Room",
                      ),
                      0.01.height.hSpace,
                      LabelsWidget(
                        label: "Available Rooms : ",
                        value: "${hotel?.availableRooms ?? 0} Room",
                      ),
                      0.01.height.hSpace,
                      SizedBox(
