...
class ViewFlightsToDelete extends StatefulWidget {

  ViewFlightsToDelete({super.key});

  @override
  State<ViewFlightsToDelete> createState() => _ViewFlightsToDeleteState();
}

class _ViewFlightsToDeleteState extends State<ViewFlightsToDelete> {
