        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Airline", style: TextStyle(fontSize: 16,
                    color: Color(0xff0d75b4),
                    fontWeight: FontWeight.bold)),
                SizedBox(height: 8),
                Container(
                  ...
                  child: Text("EgyptAir", style: TextStyle(fontSize: 16, color: Colors.grey[700])),
                ),
                SizedBox(height: 16),
              ],
            ),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Flight ID", style: TextStyle(fontSize: 16,
                    color: Color(0xff0d75b4),
                    fontWeight: FontWeight.bold)),
                SizedBox(height: 8),
                Container(
                  ...
                  child: Text("#1858", style: TextStyle(fontSize: 16, color: Colors.grey[700])),
                ),
                SizedBox(height: 16),
              ],
            ),
