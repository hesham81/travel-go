...
import '../updaeflightdeparture.dart';


class UpdateFlightDeparture extends StatefulWidget {

  UpdateFlightDeparture({super.key});

  @override
  State<UpdateFlightDeparture> createState() => _UpdateFlightDepartureState();
}

class _UpdateFlightDepartureState extends State<UpdateFlightDeparture> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Image.network("https://upload.wikimedia.org/wikipedia/commons/7/7d/Egypt_air_logo.jpg", width: 40), // Ensure this image is in assets folder
            ...
            Text("Departure Time: $time", style: const TextStyle(color: Colors.grey)),
            const SizedBox(height: 6),
            Text("Price: $price", style: const TextStyle(color: Color(0xff0d75b4), fontWeight: FontWeight.bold)),
            const SizedBox(height: 6),
            Row(
              ...
              children: [
                IconButton(onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => UpdateFlightDepartureScreen(
                      arrivalTime: TimeOfDay(hour: 14, minute: 30),
                      departureTime: TimeOfDay(hour: 15, minute: 30),
                      destinationCountry: destination,
                      sourceCountry: "Cairo",
                      startDate : DateTime(2025, 2, 25), // February 25, 2025
