...
import 'UpdateDeparture.dart';


class UpdateDepartureSelectAirline extends StatelessWidget {
  const UpdateDepartureSelectAirline({super.key});
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => UpdateFlightDeparture(),
                        ),
                      );
                    },
                    child: Container(
