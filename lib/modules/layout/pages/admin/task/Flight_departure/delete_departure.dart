...
class DeleteFlightDeparture extends StatefulWidget {

  DeleteFlightDeparture({super.key});

  @override
  State<DeleteFlightDeparture> createState() => _DeleteFlightDepartureState();
}

class _DeleteFlightDepartureState extends State<DeleteFlightDeparture> {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                IconButton(onPressed: () => _showDeleteConfirmationDialog(context), icon: const Icon(Icons.delete, color: Colors.red)),
              ],
            )
          ],
        ),
