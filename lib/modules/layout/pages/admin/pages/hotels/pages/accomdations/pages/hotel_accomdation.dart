...
class _AccommodationScreenState extends State<AccommodationScreen> {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  buildRadioSuperMenu("Room Type", roomTypes, selectedRoomType,
                      (value) {
                    setState(() {
                  ...
                  buildRadioSuperMenu(
                      "Location in Hotel", locations, selectedLocation,
                      (value) {
                    setState(() {
  ...
  Widget buildRadioSuperMenu(String title, List<String> items,
